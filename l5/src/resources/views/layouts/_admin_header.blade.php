...
<article class="supercrate-nav small-12 medium-8 columns">
    <ul class="crate-nav_admin_tabs">
        ...
        <li>{{ link_to_route('admin.siteconfigs.index','Site Configs',[],['class'=>'button tiny radius']) }}</li>
        <li>{{ link_to_route('admin.users.index','Users',[],['class'=>'button tiny radius']) }}</li>
        <li>{{ link_to('/logout','Logout',[],['class'=>'button tiny radius tag-clickme_to_logout']) }}</li>
    </ul>
