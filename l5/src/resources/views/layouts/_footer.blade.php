    ...
    <section class="row">
        <article class="col-xs-12 col-md-12 border-share ftr-social">
            <ul>
                <li class="some-logo">
    ...
    <section class="row">
        <article class="col-xs-11 col-md-9 col-xs-centered">
            ...
            <section class="row">
                ...
                <article class="superbox-addr_etc col-xs-12 col-md-6">
